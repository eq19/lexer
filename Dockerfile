...
RUN cd /home/runner/templates/doxygen && rm -rf doc/* xml/* && doxygen && \
    npm install --package-lock-only redis talib pg mathjs gauss commander handlebars object-assign winston xml2js && \     
    npm ci && cd /home/runner && node bin/moxygen.js --groups --pages --anchors --output=templates/doxygen/doc/api-%s.md templates/doxygen/xml
